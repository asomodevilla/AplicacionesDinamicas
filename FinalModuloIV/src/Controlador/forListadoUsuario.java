...
/**
 * Servlet implementation class forListadoUsuario
 */
@WebServlet("/forListadoUsuario")
public class forListadoUsuario extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public forListadoUsuario() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listarusuarios = usudao.obtenerusuario();
		request.setAttribute("llistadousuarios", listarusuarios);
